...
<body style="font-family: Arial, sans-serif; background-color: #f7f7f7; margin: 0; padding: 0;">
    <div
        style="max-width: 700px; margin: 0 auto; background: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 0 5px rgba(0,0,0,0.1);">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid #ddd; padding: 10px; background-color: #f0f0f0; text-align: left;">
                        Product</th>
                    <th style="border: 1px solid #ddd; padding: 10px; background-color: #f0f0f0; text-align: left;">Qty
                    </th>
                    <th style="border: 1px solid #ddd; padding: 10px; background-color: #f0f0f0; text-align: left;">
                        Price</th>
                    <th style="border: 1px solid #ddd; padding: 10px; background-color: #f0f0f0; text-align: left;">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="4"
                        style="border: 1px solid #ddd; padding: 10px; text-align: right; background-color: #f9f9f9; font-weight: bold;">
                        Total</td>
                    <td style="border: 1px solid #ddd; padding: 10px; background-color: #f9f9f9; font-weight: bold;">
